...
PID_Regulator_t plateSpeedPID = PID_INIT(0.7, 0.0, 0.0, 10000.0, 10000.0, 10000.0, 4900.0);//0.0, 0.00003
...
PID_Regulator_t UDBLPositionPID = PID_INIT(10.0, 0.0, 0.0, 1000000.0, 1000000.0, 1000000.0, 100000.0);
PID_Regulator_t UDBLSpeedPID = PID_INIT(1.0, 0.0, 0.0, 10000.0, 10000.0, 10000.0, 8000.0);
PID_Regulator_t UDBRPositionPID = PID_INIT(10.0, 0.0, 0.0, 1000000.0, 1000000.0, 1000000.0, 100000.0);
